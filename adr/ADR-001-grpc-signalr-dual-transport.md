...
Cons: loses protobuf type safety on the command path. REST error handling is weaker than gRPC status codes. Two separate client implementations to maintain.
